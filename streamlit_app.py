...
# Top navigation using st.columns()
col1, col2 = st.columns([2, 1])

with col1:
    page = st.selectbox("Select a page:", ["Data Preview", "Forecast and Model Evaluation"])

with col2:
    st.write("")  # Placeholder for alignment

# Main content depending on the page selected
if page == "Data Preview":
    ...
    st.subheader('Model Forecasting and Evaluation')

    # Assuming data is already processed in the previous page
    # Scaling the data
    ...
    # Dummy future actual values for comparison
    dummy_future_actual = np.random.rand(forecast_steps)  
